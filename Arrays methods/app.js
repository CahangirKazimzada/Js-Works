...
// let mapResult = arr.map((el) => el);
// console.log(mapResult);

// let someResult = (el) => el % 2 === 0;
// console.log(arr.some(someResult));

// let findResult = arr.find((el) => el % 3 === 0);
// console.log(findResult);

// const array1 = [1, 30, 4, 21, 100000];
// let sortResult = array1.sort();
// console.log(sortResult);

let arr = ['March', 'Jan', 'Feb', 'Dec', 'May'];
let letter = 'M';

let result = arr.filter((i) => i[0] === letter);
console.log(result);
